...
package com.adidas.activityisthekey.debug;
...
import com.adidas.activityisthekey.BuildConfig;
...
public class AlternateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPendingIntent = PendingIntent.getBroadcast(AlternateActivity.this, 0, intent, 0);
    ...
    private void setupFences() {
        ...
        AwarenessFence anyFence = DetectedActivityFence.during(DetectedActivityFence.ON_FOOT);
        ...
        Awareness.getFenceClient(this).updateFences(new FenceUpdateRequest.Builder()
                .addFence(FENCE_KEY, anyFence, mPendingIntent)
                .build())
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
            ...
            if (TextUtils.equals(fenceState.getFenceKey(), FENCE_KEY)) {
                ...
                switch (fenceState.getCurrentState()) {
                    case FenceState.TRUE:
                        fenceStateStr = "true";
                        Toast.makeText(AlternateActivity.this, "Running ON", Toast.LENGTH_LONG).show();
                        break;
                    case FenceState.FALSE:
                        fenceStateStr = "false";
                        Toast.makeText(AlternateActivity.this, "Running OFF", Toast.LENGTH_LONG).show();
                        break;
